...
declare const wx: {
     ...
     */
    downloadFile(object: { url: string, header: any, filePath: string, fail: (res: any) => void, complete: (res: any) => void }): DownloadTask;
    /**
     * 发起网络请求。
     */
    request(object: { url: string, data: string | any, header: any, method: string, dataType: string, success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): RequestTask;
    /**
     * 创建一个 WebSocket 连接。最多同时存在 2 个 WebSocket 连接。
     */
    connectSocket(object: { url: string, header: any, method: string, protocols: any[], success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): SocketTask;
    /**
     * 关闭 WeSocket 连接
     */
     ...
     */
    uploadFile(object: { url: string, filePath: string, name: string, header: any, formData: any, success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): UploadTask;
    /**
     ...
     */
    removeUserCloudStorage(object?: { keyList: any[], success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): any;
    /**
    ...
    * 阿拉丁触发事件
    */
    aldSendEvent(name: string, value: string | any): void;
     ...
     */
    clearStorageSync(key: string): void;
    /**
     ...
     * wx.getStorage 的同步版本
     */
    getStorageSync(key: string): any | string;
    /**
     ...
     */
    setStorage(object: { key: string, data: any | string, success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): void;
    /**
     * wx.setStorage 的同步版本
     */
    setStorageSync(key: string, data: any | string): void;
    /**
     * 隐藏消息提示框
     */
     ...
     * 显示消息提示框
     */
    showToast(object: { title: any, icon?: any, duration?: number, image?: any, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
...
declare interface FileSystemManager {
     ...
     * 删除目录
     */
    rmdir(object: { dirPath: any, success: (res: any) => void, fail: (res: any) => void, complete: (res: any) => void }): void;
    /**
     * 读取目录内文件列表
     */
