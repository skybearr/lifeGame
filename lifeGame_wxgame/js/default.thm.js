var egret = window.egret;
	...
	_proto.gp_btn_i = function () {
		...
		t.width = 750;
		t.x = 0;
		t.elementsContent = [this._Image10_i(),this._Group1_i()];
		return t;
	};
	...
	_proto.gp_pop_i = function () {
		...
		t.touchEnabled = false;
		t.width = 750;
		t.elementsContent = [this._Image11_i(),this.gp_4_i(),this.gp_5_i(),this.gp_6_i(),this.gp_7_i(),this.gp_8_i(),this.gp_9_i(),this.gp_10_i()];
		return t;
	};
	...
	_proto.gp_value_i = function () {
		...
		t.touchEnabled = false;
		t.x = 0;
		t.elementsContent = [this._Image12_i(),this._Image13_i(),this._Group2_i()];
		return t;
	};
	...
	_proto.gp_over_i = function () {
		...
		t.visible = false;
		t.width = 750;
		t.elementsContent = [this.img_over_bg1_i(),this.img_over_bg0_i(),this._Image15_i(),this.lbl_over_1_i(),this.btn_26_i(),this.btn_28_i(),this.btn_27_i()];
		return t;
	};
