var egret = window.egret;
	...
	_proto.lbl_event_1_i = function () {
		...
		t.height = 90;
		t.horizontalCenter = 0;
		t.text = "你将扮演一位外地来苏州打工的青年。一开始你的兜里只剩5000元，还欠了村长5500元债务。这些债务每天的利息高达10%。如果不及时还清，你可能会因为压力太大影响身体健康。你可以在市场之间倒卖各种物品来发财致富，最终荣登富人榜。你会遭遇各种事件，让你感到浮生艰难。\n        你只能在苏州呆40天，每次奔走一个市场都算一天。一开始，你的出租屋只能放100个东西，有钱了可以找中介扩充出租屋。";
		t.touchEnabled = false;
		t.width = 480;
		return t;
	};
